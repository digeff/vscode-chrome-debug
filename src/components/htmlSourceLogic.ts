 ...
 */
export function retrievabilityWithHTMLSupport(_wrappedRetrievability: GetSourceTextRetrievability, scriptSources: IScriptSourcesRetriever, resourceContentGetter: CDTPResourceContentGetter, loadedSource: ILoadedSource): IPossiblyRetrievableText {
    const existingRetrievability = _wrappedRetrievability(scriptSources, loadedSource);
