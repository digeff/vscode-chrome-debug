import {
    inject, logger, TYPES, IInspectDebugeeState, ConnectedCDAConfiguration, telemetry,
    utils as coreUtils, INetworkCacheConfiguration, IDebugeeVersionProvider
...
export class ReportVersionInformation {
    ...
    constructor(
        ...
        @inject(TYPES.INetworkCacheConfiguration) private readonly _networkCacheConfiguration: INetworkCacheConfiguration,
        @inject(TYPES.IDebugeeVersionProvider) private readonly _debugeeVersionProvider: IDebugeeVersionProvider) {
    }
}