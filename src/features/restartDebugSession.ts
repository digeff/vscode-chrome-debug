import { inject, TYPES, IBrowserNavigation } from 'vscode-chrome-debug-core';
...
export class RestartDebugSession {
    ...
    constructor(@inject(TYPES.IBrowserNavigation) private readonly _browserNavigation: IBrowserNavigation) { }
}
