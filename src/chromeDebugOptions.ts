...
import { OnlyProvideCustomLauncherExtensibilityPoints, UrlPathTransformer, GetSourceTextRetrievability, IScriptSourcesRetriever,
...
extensibilityPoints.bindAdditionalComponents = (diContainer: DependencyInjection) => {
    ...
    diContainer.configureClass(TYPES.ChromeConnection, ChromeProvidedPortConnection);
};
